...
sudo mkdir /usr/src/mk_arcade_joystick_rpi-0.1.5.9
sudo cp -a * /usr/src/mk_arcade_joystick_rpi-0.1.5.9/
...
sudo dkms build -m mk_arcade_joystick_rpi -v 0.1.5.9
sudo dkms install -m mk_arcade_joystick_rpi -v 0.1.5.9 --force
